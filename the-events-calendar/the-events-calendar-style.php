...
if ( ! function_exists( 'tuning_tribe_events_get_css' ) ) {
	add_filter( 'tuning_filter_get_css', 'tuning_tribe_events_get_css', 10, 2 );
	function tuning_tribe_events_get_css( $css, $args ) {
