...
if ( ! function_exists( 'tuning_woocommerce_get_css' ) ) {
	add_filter( 'tuning_filter_get_css', 'tuning_woocommerce_get_css', 10, 2 );
	function tuning_woocommerce_get_css( $css, $args ) {
...
$fdir = tuning_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
