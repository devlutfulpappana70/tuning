...
Please install and activate it before starting to use the theme Tuning.
...
Theme documentation is available on https://doc.themerex.net/tuning/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Tuning is Fontello.
