...
if ( ! function_exists( 'tuning_trx_addons_get_css' ) ) {
	add_filter( 'tuning_filter_get_css', 'tuning_trx_addons_get_css', 10, 2 );
	function tuning_trx_addons_get_css( $css, $args ) {
